    ...
    public void loadVideosList () {
        ...
        gridview.setOnItemClickListener( new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Toast.makeText( Itvtube.this, "" + position, Toast.LENGTH_SHORT ).show();
            }
        });
        ...
        JsonObjectRequest videosListReq = new JsonObjectRequest(
                getResources().getString( R.string.url_itvtube_videos ),
                null,
        ...
        videosListReq.setRetryPolicy(
                new DefaultRetryPolicy( 0, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT )
        );
