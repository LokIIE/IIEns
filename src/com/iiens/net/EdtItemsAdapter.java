...
//		LinearLayout mSpinner = (LinearLayout) arg2.findViewById(R.id.spinner_layout);
		...
		else if (type.equals("TP")) arg1 = inflater.inflate(R.layout.edt_item_tp, arg2,false);
		...
		mEdtItem.setText(horaire + " : " + type + " de " + matiere + " en " + salle + prof + groupe);
